			...
			<div class="pad group">
				...
				<div class="grid one-full">
					...
					<div id="copyright">
						...
						<?php else: ?>
							<p><?php bloginfo(); ?> &copy; <?php echo esc_html( date_i18n( esc_html__( 'Y', 'typesolid' ) ) ); ?>. <?php esc_html_e( 'All Rights Reserved.', 'typesolid' ); ?></p>
						<?php endif; ?>
					</div><!--/#copyright-->
					
					<?php if ( get_theme_mod( 'credit', 'on' ) == 'on' ): ?>
					<div id="credit">
						<p><?php esc_html_e('Powered by','typesolid'); ?> <a href="http://wordpress.org" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','typesolid'); ?> <a href="https://agnarson.com" rel="nofollow">Alx</a>.</p>
					</div><!--/#credit-->
					<?php endif; ?>
